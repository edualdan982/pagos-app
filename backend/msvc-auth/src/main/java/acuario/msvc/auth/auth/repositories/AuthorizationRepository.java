...
import acuario.msvc.auth.auth.entity.Authorization;
...
public interface AuthorizationRepository extends JpaRepository<Authorization, String> {
  ...
  @Query("select a from Authorization a where a.state = :token or a.authorizationCodeValue = :token or a.accessTokenValue = :token or a.refreshTokenValue = :token or a.oidcIdTokenValue = :token or a.userCodeValue = :token or a.deviceCodeValue = :token")
